    ...
    <footer className="footer">
      ...
      <div className="footer__linkContainer">
        <div className="footer__links">
          ...
          <p className="footer__link">Green Coice Cares</p>
        ...
        <div className="footer__links">
          ...
          <p className="footer__link">Sell on Green Choice</p>
          <p className="footer__link">Sell under Green Choice Accelerator</p>
          <p className="footer__link">Green Choice Global Selling</p>
        ...
        <div className="footer__links">
          ...
          <p className="footer__link">COVID-19 and Green Choice</p>
          ...
          <p className="footer__link">Green Choice App Download</p>
